...
(function () {
  ...
  function getJobDetails() {
    try {
      const title =
        ...
        document.querySelector('h1.icl-u-xs-mb--xs')?.innerText?.trim() ||
  ...
  function watchForApplyButton() {
    document.addEventListener('click', function (e) {
      ...
      // Indeed specific apply button detection
      if (
        buttonText.includes('apply now') ||
        buttonText.includes('easy apply') ||
        buttonText.includes('apply') ||
        buttonId.includes('indeedApplyButton') ||
        buttonClass.includes('indeed-apply-button') ||
        buttonClass.includes('jobsearch-IndeedApplyButton')
      ) {
